...
{
    public class LowElasticServiceTest : ElasticQueryCase
    {
        public LowElasticServiceTest()
        {
        ...
        protected IServiceProvider GetServiceProvider()
        {
            ...
            {
                Urls = new List<string> { "http://192.168.1.193:9200" },
        ...
        public void GetElasticService()
        {
            using (var scope = serviceProvider.CreateScope())
            {
                ...
                Assert.IsType<LowElasticService>(clientService);
            }
        }
    }
}
